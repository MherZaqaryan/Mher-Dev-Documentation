...
<head>
    <meta name="title" content="Mher Developement | BedWars1058 Private Games 🔒"></meta>
    <meta name="description" content="This is an add-on for the BedWars1058 plugin, this add-on allows players to create private BedWars games and play with their friends! Private game hoster can modify game's difficulty to either harder or easier with game modifiers."/>
